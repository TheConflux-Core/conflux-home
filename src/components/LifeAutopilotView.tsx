...
export default function LifeAutopilotView() {
  ...
  if (loading && !dashboard) return <div className="mission-control-view" style={{ paddingTop: '50px', paddingBottom: '150px', paddingLeft: '121px', paddingRight: '121px' }}><div className="mc-loading">Loading your orbit...</div></div>;
