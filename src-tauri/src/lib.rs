    ...
    builder
        .setup(|app| {
            ...
            #[cfg(desktop)]
            {
                ...
                // llama-server keeps running so the app can be restored from the tray.
                // Use the tray Quit menu (or Task Manager) to fully exit before installing updates.
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Kitchen Hearth
            commands::kitchen_tonights_menu,
            commands::kitchen_chefs_specials,
            ...
            engine::pulse::pulse_delete_stock,
            ...
            engine::pulse::pulse_delete_holding,
            engine::pulse::pulse_add_investment_goal,
            engine::pulse::pulse_get_investment_goals,
            engine::pulse::pulse_update_investment_goal,
            engine::pulse::pulse_delete_investment_goal,
            engine::pulse::pulse_chat,
            engine::pulse::pulse_health_score,
            // Pulse Finance Advisor
            commands::pulse_start_session,
            commands::pulse_end_session,
            commands::pulse_get_messages,
            commands::pulse_get_sessions,
            commands::pulse_save_message,
            commands::pulse_increment_session_count,
            // Content Feed
            ...
            commands::studio_get_daily_count,
            commands::studio_get_daily_limit,
            commands::studio_get_user_tier,
            commands::studio_set_user_tier,
            commands::studio_get_tier_features,
            ...
            commands::watchtower_scan,
            commands::watchtower_get_status,
            commands::watchtower_get_events,
            commands::watchtower_get_baselines,
            commands::watchtower_rescan,
            commands::watchtower_snapshot_processes,
            commands::watchtower_get_processes,
            commands::watchtower_kill_process,
            commands::watchtower_snapshot_connections,
            commands::watchtower_get_connections,
            // Remediation Engine (Phase 7)
            commands::remediation_dry_run,
            commands::remediation_execute,
            commands::remediation_undo,
            commands::remediation_get_log,
            commands::remediation_has_fix,
            // Agent Quarantine — Sentinel (Phase 8)
            commands::quarantine_get_status,
            commands::quarantine_get_level,
            commands::quarantine_escalate,
            commands::quarantine_release,
            commands::quarantine_get_history,
            commands::quarantine_get_all,
            commands::quarantine_run_auto_escalation,
            commands::quarantine_can_respond,
            // Network Discovery — Phase 9
            commands::network_scan,
            commands::network_get_devices,
            commands::network_get_events,
            commands::network_get_map,
            commands::network_rename_device,
            commands::network_mark_known,
            commands::network_delete_device,
