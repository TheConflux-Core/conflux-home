...
pub fn get_providers() -> Vec<ModelProvider> {
    vec![
        ModelProvider {
            ...
            api_key: "REDACTED_CEREBRAS_KEY".to_string(),
        ...
        ModelProvider {
            ...
            api_key: "GROQ_KEY_REDACTED".to_string(),
        ...
        ModelProvider {
            ...
            api_key: "MISTRAL_KEY_REDACTED".to_string(),
        ...
        ModelProvider {
            ...
            api_key: "CLOUDFLARE_KEY_REDACTED".to_string(),
